...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\Column(type: Types::DATETIME_MUTABLE, nullable: true)]
    private ?\DateTimeInterface $deleteAccountDate = null;

    #[ORM\Column(type: Types::DATETIME_MUTABLE, nullable: true)]
    private ?\DateTimeInterface $lastConnection = null;

    #[ORM\OneToMany(mappedBy: 'player', targetEntity: Pick::class)]
    ...
    public function getDeleteAccountDate(): ?\DateTimeInterface
    {
        return $this->deleteAccountDate;
    }

    public function setDeleteAccountDate(?\DateTimeInterface $deleteAccountDate): self
    {
